            ...
            <div class="ct-wrap-inner">
                <div class="breadcrumb">
                    <div class="bread-tit">
                        ...
                        <p class="num-count">Bạn hiện đang có : <em><?= $totalcate?></em> Chuyên Mục</p>
                    </div>
                    <div class="bread-btn">
                    ...
                    <table class="list-table">
                        ...
                        foreach ($catelist as $cate_item) {?>
                            <tr class="list-data">
                                ...
                                <td class="tit-data"><?echo $cate_item["cate_name"]?></td>
                                <td class="num-data"><?echo $cate_item["total_news"]?> <span>Bài Viết</span></td>
                                <td class="action-data">
                                    <a href="cate_edit.php?id=<?=$cate_item["cateid"]?>"><i class="fa fa-pencil"></i></a>&nbsp;&nbsp;
                                    <a href="cate_del.php?id=<?=$cate_item["cateid"]?>" onclick="return xacnhan(\'Bạn có chắc muốn xóa danh mục có ID là: <?= $cate_item["cateid"]?>\');"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                    <?    }
                    }?>
