            ...
            <div class="ct-wrap-inner">
                <div class="breadcrumb">
                    <div class="bread-tit">
                        ...
                        <p class="num-count">Bạn hiện đang có : <em><?= $total_comments?></em> Bình Luận</p>
                    </div>
                    <div class="bread-btn">
                    ...
                    <table class="list-table">
                        ...
                        foreach ($list as $comment_item) {?>
                            <tr class="list-data">
                                ...
                                <td class="id-data"><?echo $comment_item["username"]?></td>
                                <td class="user-data"><?echo $comment_item["news_title"]?></td>
                                <td class="phone-data"><?echo $comment_item["comment_content"]?></td>
                                <td class="email-data"><?echo $comment_item["comment_date"]?></td>
                                <td class="action-data">
                                    <a href="comment_del.php?id=<?=$comment_item["commentid"]?>" onclick="return xacnhan(\'Bạn có chắc muốn xóa comment có STT là: <?$stt?>');"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                    <?    }
                    }?>
