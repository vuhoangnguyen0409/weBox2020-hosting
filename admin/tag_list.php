...
$tag = new Tag();
// Khai báo phân trang
$totalRecord = $tag->totalTag();
$totalPage =  ceil($totalRecord / $rowPerPage);
$limit = 'limit ' .$startRecord. ', '.$rowPerPage;
// Liet ke tag
$taglist = $tag->listAllTag($limit);
$totalTag = $tag->totalTag();
            ...
            <div class="ct-wrap-inner">
                <div class="breadcrumb">
                    <div class="bread-tit">
                        ...
                        <p class="num-count">Bạn hiện đang có : <em><?php echo $totalTag?></em> Thẻ</p>
                    </div>
                    <div class="bread-btn">
                        <div class="btn-down"><a href=""><i class="fa fa-download"></i> Tải xuống</a></div>
                        <div class="btn-add"><a href="=/../tag_add.php">+</a></div>
                    </div>
                </div>
                    ...
                    <table class="list-table">
                        ...
                        foreach ($taglist as $tag_item) {?>
                            <tr class="list-data">
                                ...
                                <td class="tit-data"><?php echo $tag_item["tag_name"]?></td>
                                <td class="num-data"><?php echo $tag_item["total_detail"]?> <span>Bài Viết</span></td>
                                <td class="action-data">
                                    <a href="tag_edit.php?id=<?php echo $tag_item["tagid"]?>"><i class="fa fa-pencil"></i></a>&nbsp;&nbsp;
                                    <a href="tag_del.php?id=<?php echo $tag_item["tagid"]?>" onclick="return xacnhan('Bạn có chắc muốn xóa danh mục có ID là: <?php echo $tag_item["tagid"]?>');"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                    <?php     }
                    }?>
