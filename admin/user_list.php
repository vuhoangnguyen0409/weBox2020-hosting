            ...
            <div class="ct-wrap-inner">
                <div class="breadcrumb">
                    <div class="bread-tit">
                        ...
                        <p class="num-count">Bạn hiện đang có : <em><?echo $total_user?></em> Thành Viên</p>
                    </div>
                    <div class="bread-btn">
                    ...
                    <table class="list-table">
                        ...
                        foreach ($list as $user_item) {?>
                            <tr class="list-data">
                                ...
                                <td class="id-data"><?echo $user_item["userid"]?></td>
                                <td class="user-data"><?echo $user_item["username"]?></td>
                                <td class="phone-data"><?echo $user_item["tel"]?></td>
                                <td class="email-data"><?echo $user_item["email"]?></td>
                                <td class="role-data">
                                ...
                                <td class="text-center">
                                    <a href="user_edit.php?id=<?echo $user_item["userid"]?>"><img src="images/edit.png" /></a>&nbsp;&nbsp;
                                    <a href="user_del.php?id=<?echo $user_item["userid"]?>" onclick="return xacnhan(\'Bạn có chắc muốn xóa user có ID là: <? echo $user_item["userid"]?>\');"><img src="images/delete.png" /></a>
                                </td>
                            </tr>
                    <?    }
                    }?>
