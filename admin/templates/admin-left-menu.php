...
<div class="admin-nav-menu">
    <ul>
        <li><a href="<?php echo $siteURL?>" target="_blank"><i class="fa fa-home"></i> Trang Chủ</a></li>
        ...
        <li><a><i class="far fa-file-word"></i> Giao Diện Website<i class="fa fa-chevron-down"></i></a>
            <ul class="dropdown">
